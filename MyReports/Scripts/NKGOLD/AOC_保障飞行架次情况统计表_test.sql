...
from PL_ARRIVAL A
WHERE  TO_CHAR(A.PA_SRTA- 5/24,'yyyy-mm-dd') BETWEEN TO_CHAR(TO_DATE('2017-03-06 00:00:00','yyyy-mm-dd hh24:mi:ss'),'yyyy-mm-dd') AND TO_CHAR(TO_DATE('2017-03-08 00:00:00','yyyy-mm-dd hh24:mi:ss'),'yyyy-mm-dd') AND A.PA_RFST_FLIGHTSTATUS !='X'and A.PA_pa_mainflight is null

union
select d.pd_idseq ,TO_CHAR(D.PD_srtd- 5/24,'yyyy-mm-dd') as fdate , D.PD_RSTC_SERVICETYPECODE as typeCode
from PL_DEPARTURE D
WHERE  TO_CHAR(D.PD_srtd- 5/24,'yyyy-mm-dd') BETWEEN TO_CHAR(TO_DATE('2017-03-06 00:00:00','yyyy-mm-dd hh24:mi:ss'),'yyyy-mm-dd') AND TO_CHAR(TO_DATE('2017-03-08 00:00:00','yyyy-mm-dd hh24:mi:ss'),'yyyy-mm-dd') AND D.PD_RFST_FLIGHTSTATUS !='X' and  D.Pd_pd_mainflight is null
...
from PL_DEPARTURE D
WHERE  TO_CHAR(D.PD_srtd- 5/24,'yyyy-mm-dd') BETWEEN TO_CHAR(TO_DATE('2017-03-06 00:00:00','yyyy-mm-dd hh24:mi:ss'),'yyyy-mm-dd') AND TO_CHAR(TO_DATE('2017-03-08 00:00:00','yyyy-mm-dd hh24:mi:ss'),'yyyy-mm-dd') AND D.PD_RFST_FLIGHTSTATUS ='X' and  D.Pd_pd_mainflight is null
group by TO_CHAR(D.PD_srtd- 5/24,'yyyy-mm-dd')) Xdep on bbb.dfdate = Xdep.fdate 
left join (
select gjfdate ,count(1) as gjcnt from(

select A.pa_idseq,TO_CHAR(A.PA_SRTA- 5/24,'yyyy-mm-dd') as gjfdate
from PL_ARRIVAL A
WHERE  A.PA_RCTT_COUNTRYTYPE    IN ('I','M','R')  AND  (TO_CHAR(A.PA_SRTA- 5/24,'yyyy-mm-dd') BETWEEN TO_CHAR(TO_DATE('2017-03-06 00:00:00','yyyy-mm-dd hh24:mi:ss'),'yyyy-mm-dd') AND TO_CHAR(TO_DATE('2017-03-08 00:00:00','yyyy-mm-dd hh24:mi:ss'),'yyyy-mm-dd')) AND A.PA_RFST_FLIGHTSTATUS !='X'and A.PA_pa_mainflight is null

union
select d.pd_idseq ,TO_CHAR(D.PD_srtd- 5/24,'yyyy-mm-dd') as gjfdate 
from PL_DEPARTURE D
WHERE  D.PD_RCTT_COUNTRYTYPE    IN ('I','M','R') AND  (TO_CHAR(D.PD_srtd- 5/24,'yyyy-mm-dd') BETWEEN TO_CHAR(TO_DATE('2017-03-06 00:00:00','yyyy-mm-dd hh24:mi:ss'),'yyyy-mm-dd') AND TO_CHAR(TO_DATE('2017-03-08 00:00:00','yyyy-mm-dd hh24:mi:ss'),'yyyy-mm-dd')) AND D.PD_RFST_FLIGHTSTATUS !='X' and  D.Pd_pd_mainflight is null
) group by gjfdate
) gjall on bbb.dfdate = gjall.gjfdate order by bbb.dfdate;